...
import Footer from '@/components/common/footer/async';
import { useEffect, useRef, useMemo } from 'react';
import { useRouter } from 'next/router';
import { myAccountTabs } from '@/utils/accountTypes';
import Gallery from './tabs/gallery/gallery';
import HomeCategory from '../strapi/components/gridmodulesection/components/homeCategory';
import AiTools from './tabs/ai-tools/ai-tools';
import AiAgent from './tabs/ai-agent/ai-agent';
import useSwitchTab from './hooks/use-switch-tab';
import Tab from './components/tab';
import DragScrollWrapper from '../common/drag-scroll-wrapper';
import useLogic from './hooks/use-logic';
import useAccountRedDots from './hooks/use-account-red-dots';
import AccountRedDotsContext from './context/account-red-dots-context';
import { getTranslationFunction } from '@/i18n';
import useWindowDevice from '@/hooks/use-window-device';
import _isEqual from 'lodash/isEqual';
import _get from 'lodash/get';
import _size from 'lodash/size';
import useHomeCategory from '@/components/strapi/components/gridmodulesection/hooks/use-home-category';
