...
import { ButtonWrapper as ButtonWrapper } from './adapters.jsx';
...
import { useDispatch, useSelector } from './adapters.jsx';
import { useRouter } from './adapters.jsx';
import { setCrossPageState } from './adapters.jsx';
import { ProcessingTypes, TaskTypes } from './adapters.jsx';
import { routerUtils as routerUtils } from './adapters.jsx';
import Dotdotdot from 'react-dotdotdot';
import { getTranslationFunction } from './adapters.jsx';
import { useEditProject as useEditProject } from './adapters.jsx';
import { useHandleRecentFiles as useHandleRecentFiles } from './adapters.jsx';
import { useHandleInput as useHandleInput } from './adapters.jsx';
import { useUpdateResultRedux as useUpdateResultRedux } from './adapters.jsx';
import { getHotNewFlagsFromTabs } from './hot-new-tag-utils.js';
import { setAIGenerateEntrySource } from './adapters.jsx';
import { isAIGenerateVideoModuleType } from './adapters.jsx';
import { moduleTypeUtils as moduleTypeUtils } from './adapters.jsx';
...
export default function Card(props) {
  ...
  const getIconImageSrc = () => {
    return card?.icon?.data?.attributes?.url
      ...
      : assetMap["/assets/images/header/start_editing_icon_black.svg"]; // use default image if icon.data is null
  };
              ...
              {!isVideo && (
                ...
                >
                  <img
                    ...
                    src={assetMap["/assets/images/strapi/grid-module/start_editing.png"]}
                    loading="lazy"
                  />
                  <div className={styles.hoverBlock}>
                    <img
                      className={styles.typeIcon}
                      src={assetMap["/assets/images/strapi/grid-module/start_editing_icon.svg"]}
                      loading="lazy"
                    />
                    <img
