...
import { sessionStorageUtils as sessionStorageUtils } from './adapters.jsx';
import { sessionStorageTypes } from './adapters.jsx';
...
import { useHeaderGeneral as useHeaderGeneral } from './adapters.jsx';
import { setCurrentSectionId } from './adapters.jsx';
import {
  setHeaderMenuOpened,
  setLoginModalOpen,
} from './adapters.jsx';
import { useShowContest as useShowContest } from './adapters.jsx';
import { useUserStatus as useUserStatus } from './adapters.jsx';
import StartEditingButton from './StartEditingButton.jsx';
import { GalleryPickerModal as GalleryPickerModal } from './adapters.jsx';
import { ExternalLink as ExternalLink } from './adapters.jsx';
    ...
    const baseHome = [
      {
        ...
        icon: assetMap["/assets/images/header/icon_home.svg"],
        iconName: 'ic-home',
      ...
      })),
      {
        ...
        icon: assetMap["/assets/images/header/icon_gallery.svg"],
      ...
      },
      {
        ...
        icon: assetMap["/assets/images/header/youcam-ai-contest.png"],
        iconName: null,
    ...
    const base = [
      {
        ...
        icon: assetMap["/assets/images/header/icon_api.svg"],
        iconName: 'ic-api-b',
        onSelect: onClickAPI,
      },
    ];
