...
import { ImageLazyLoad as ImageLazyLoad } from './adapters.jsx';
import { browserUtils as browserUtils } from './adapters.jsx';
import { posterFrameSrc } from './adapters.jsx';
import { uuidv4 } from './adapters.jsx';
        ...
        >
          {isSelected && (
            <img
              ...
              src={assetMap["/assets/images/icon_check_thumbnail_w.svg"]}
              alt=""
            />
          )}
        </span>
